...
EfficientNet Series with GroupNL Conv
Modified from timm
Author: Xie Jianhang
...
from models.efficientnet_gnl_blocks import SqueezeExcite
from models.efficientnet_gnl_builder import EfficientNetBuilder, decode_arch_def, efficientnet_init_weights,\
...
@register_model
def mobilenetv2_gnl_100(pretrained=False, **kwargs):
...
@register_model
def efficientnet_gnl_b0(pretrained=False, **kwargs):
    """ EfficientNet-B0 """
...
@register_model
def efficientnet_gnl_es(pretrained=False, **kwargs):
...
@register_model
def efficientnet_gnl_lite0(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
...
@register_model
def efficientnetv2_gnl_s(pretrained=False, **kwargs):
