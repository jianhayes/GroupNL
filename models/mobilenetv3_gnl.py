...
MobileNet V3 with GroupNL Conv
Modified from timm
Author: Xie Jianhang
...
@register_model
def mobilenetv3_gnl_large_075(pretrained=False, **kwargs):
    """ MobileNet V3 """
...
@register_model
def mobilenetv3_gnl_large_100(pretrained=False, **kwargs):
    """ MobileNet V3 """
...
@register_model
def mobilenetv3_gnl_small_075(pretrained=False, **kwargs):
    """ MobileNet V3 """
...
@register_model
def mobilenetv3_gnl_small_100(pretrained=False, **kwargs):
    """ MobileNet V3 """
